  ...
  return (
    <>
      <div className='w-full h-screen duration-200' style={{ backgroundColor: color }}>
        {/* direct inject variable into inline css, no need to {} for css. 
      Note: Achha ek bat hai yhan pe hamm css me bhi variables inject kar sakte hai!*/}
        <div className='fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
          <div className='flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-xl'>
            ...
            <button onClick={() => setColor("darkcyan")} className='outline-none px-4 py-1 rounded-full text-white shadow-lg' style={{ backgroundColor: 'darkcyan' }}>Darkcyan</button>
            ...
            <button onClick={() => setColor("lavender")} className='outline-none px-4 py-1 rounded-full text-b;ack shadow-lg' style={{ backgroundColor: 'lavender' }}>Lavender</button>
